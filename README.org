...
* Example: simulation of harmonic oscillator
  ...
  The idea behind this library is can be most easily demonstrated on an example. We will run simulation of a harmonic oscillator.

  Harmonic oscillator is defined by its Hamiltonian. In Lean this can done with 
#+begin_src
