...
* Installation and running examples and tests

As we are using Lean programming language, you need Lean's version manager =elan=. Follow its installation follow these [[https://github.com/leanprover/elan#installation][instructions]].
