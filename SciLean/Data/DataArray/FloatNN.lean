...
namespace Float22
  ...
  instance : DataArrayEquiv Float22 (Fin 2 × Fin 2) Float where
    equiv := {
  ...
  instance {I} [IndexType I] : DefaultDataArrayEquiv (Float22^[I]) (I × Fin 2 × Fin 2) Float where
...
namespace Float33
  ...
  instance : GetElem' Float33 (Fin 3 × Fin 3) Float where
    getElem A i _ :=
      match i with
      | ⟨⟨0,_⟩,⟨0,_⟩⟩ => A.xx
      | ⟨⟨0,_⟩,⟨1,_⟩⟩ => A.xy
  ...
  instance : SetElem' Float33 (Fin 3 × Fin 3) Float where
    setElem A i v _ :=
      match i with
      | ⟨⟨0,_⟩,⟨0,_⟩⟩ => { A with xx := v }
      | ⟨⟨0,_⟩,⟨1,_⟩⟩ => { A with xy := v }
  ...
  instance : DefaultIndex Float33 (Fin 3 × Fin 3) where

  instance : InjectiveGetElem Float33 (Fin 3 × Fin 3) where
    getElem_injective := by
  ...
  instance : OfFn Float33 (Fin 3 × Fin 3) Float where
    ofFn f := ⟨f (0,0), f (0,1), f (0,2), f (1,0), f (1,1), f (1,2), f (2,0), f (2,1), f (2,2)⟩

  instance : LawfulOfFn Float33 (Fin 3 × Fin 3) where
    getElem_ofFn := by
      intro f i;
      match i with
      | ⟨⟨0,_⟩,⟨0,_⟩⟩ => rfl
  ...
  instance : DataArrayEquiv Float33 (Fin 3 × Fin 3) Float where
    equiv := {
  ...
  instance {I} [IndexType I] : DefaultDataArrayEquiv (Float33^[I]) (I × Fin 3 × Fin 3) Float where
...
namespace Float44
  ...
  instance : GetElem' Float44 (Fin 4 × Fin 4) Float where
    getElem A i _ :=
      match i with
      | ⟨⟨0,_⟩,⟨0,_⟩⟩ => A.xx
      | ⟨⟨0,_⟩,⟨1,_⟩⟩ => A.xy
  ...
  instance : SetElem' Float44 (Fin 4 × Fin 4) Float where
    setElem A i v _ :=
      match i with
      | ⟨⟨0,_⟩,⟨0,_⟩⟩ => { A with xx := v }
      | ⟨⟨0,_⟩,⟨1,_⟩⟩ => { A with xy := v }
  ...
  instance : DefaultIndex Float44 (Fin 4 × Fin 4) where

  instance : InjectiveGetElem Float44 (Fin 4 × Fin 4) where
    getElem_injective := by
  ...
  instance : DataArrayEquiv Float44 (Fin 4 × Fin 4) Float where
    equiv := {
  ...
  instance {I} [IndexType I] : DefaultDataArrayEquiv (Float44^[I]) (I × Fin 4 × Fin 4) Float where
