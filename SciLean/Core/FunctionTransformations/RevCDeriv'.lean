...
def discharger (e : Expr) : SimpM (Option Expr) := do
  withTraceNode `revCDeriv'_discharger (fun _ => return s!"discharge {← ppExpr e}") do
  let cache := (← get).cache
...
@[ftrans]
theorem Prod.mk.arg_fstsnd.revCDeriv'_rule_at
  (g : X → Y) (f : X → Z) (x : X)
...
@[ftrans]
theorem Prod.mk.arg_fstsnd.revCDeriv'_rule
  (g : X → Y) (f : X → Z)
...
@[ftrans]
theorem Prod.fst.arg_self.revCDeriv'_rule_at
...
@[ftrans]
theorem Prod.fst.arg_self.revCDeriv'_rule
...
@[ftrans]
theorem Prod.snd.arg_self.revCDeriv'_rule_at
  (f : X → Y×Z) (x : X) (hf : HasAdjDiffAt K f x)
...
@[ftrans]
theorem Prod.snd.arg_self.revCDeriv'_rule
  (f : X → Y×Z) (hf : HasAdjDiff K f)
...
-- @[ftrans]
-- theorem Function.comp.arg_fga0.revCDeriv'_rule 
...
@[ftrans]
theorem HAdd.hAdd.arg_a0a1.revCDeriv'_rule_at
...
@[ftrans]
theorem HAdd.hAdd.arg_a0a1.revCDeriv'_rule
...
@[ftrans]
theorem HSub.hSub.arg_a0a1.revCDeriv'_rule_at
  (f g : X → Y) (x : X) (hf : HasAdjDiffAt K f x) (hg : HasAdjDiffAt K g x)
  : (revCDeriv' K fun x => f x - g x) x
    =
    let ydf := revCDeriv' K f x
...
@[ftrans]
theorem HSub.hSub.arg_a0a1.revCDeriv'_rule
  (f g : X → Y) (hf : HasAdjDiff K f) (hg : HasAdjDiff K g)
  : (revCDeriv' K fun x => f x - g x)
    =
    fun x => 
...
@[ftrans]
theorem Neg.neg.arg_a0.revCDeriv'_rule
  (f : X → Y) (x : X) 
...
@[ftrans]
theorem HMul.hMul.arg_a0a1.revCDeriv'_rule_at
  (f g : X → K) (x : X)
...
@[ftrans]
theorem HMul.hMul.arg_a0a1.revCDeriv'_rule
  (f g : X → K)
  (hf : HasAdjDiff K f) (hg : HasAdjDiff K g)
  : (revCDeriv' K fun x => f x * g x)
    =
...
@[ftrans]
theorem HSMul.hSMul.arg_a0a1.revCDeriv'_rule_at
  (f : X → K) (g : X → Y) (x : X) 
  (hf : HasAdjDiffAt K f x) (hg : HasAdjDiffAt K g x)
  : (revCDeriv' K fun x => f x • g x) x
    =
...
@[ftrans]
theorem HSMul.hSMul.arg_a0a1.revCDeriv'_rule
  {Y : Type _} [NormedAddCommGroup Y] [InnerProductSpace K Y] [CompleteSpace Y]
  (f : X → K) (g : X → Y)
  (hf : HasAdjDiff K f) (hg : HasAdjDiff K g)
  : (revCDeriv' K fun x => f x • g x)
...
@[ftrans]
theorem HDiv.hDiv.arg_a0a1.revCDeriv'_rule_at
  (f g : X → K) (x : X)
...
@[ftrans]
theorem HDiv.hDiv.arg_a0a1.revCDeriv'_rule
  (f g : X → K)
...
@[ftrans]
def HPow.hPow.arg_a0.revCDeriv'_rule_at
...
@[ftrans]
def HPow.hPow.arg_a0.revCDeriv'_rule
...
@[ftrans]
theorem SciLean.EnumType.sum.arg_f.revCDeriv'_rule {ι : Type _} [EnumType ι]
...
@[ftrans]
theorem Inner.inner.arg_a0a1.revCDeriv'_rule
  (f : X → Y) (g : X → Y)
...
@[ftrans]
theorem SciLean.Norm2.norm2.arg_a0.revCDeriv'_rule
  (f : X → Y)
  (hf : HasAdjDiff R f) 
...
@[ftrans]
theorem SciLean.norm₂.arg_x.revCDeriv'_rule_at
  (f : X → Y) (x : X)
...
@[ftrans]
theorem SciLean.semiAdjoint.arg_a3.revCDeriv'_rule
...
--       fom the support for monadic `fwd/revCDeriv'ValM`. This should have first 
--       class support.
@[fprop]
